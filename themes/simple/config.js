const CONFIG = {
  ...
  SIMPLE_LOGO_DESCRIPTION: process.env.NEXT_PUBLIC_THEME_SIMPLE_LOGO_DESCRIPTION || '<div>Discover the Technology Behind Lotso 🌐<br/>/Unveiling the Future of Cryptocurrency 💡<br/>/Join Our Journey into the Digital Frontier 🚀</div>',
